...
function _createPanel(id: string, label: string): vscode.WebviewPanel {
  const panel = vscode.window.createWebviewPanel(id, label, vscode.ViewColumn.One, {
    enableScripts: true,
 ...
 * @param page 页码
 */
function loadTopicListInPanel(panel: vscode.WebviewPanel, item: ForumItem, forumState: ForumState) {
